...
class MainWindow(QMainWindow):
    ...
    def init_result(self):
        ...
        self.label_result_table = QLabel("detect Result")
    ...
    def init_history(self):
        ...
        self.table_history.setHorizontalHeaderLabels(['Name',"Total Vehicle Detect","Total of Illegal vehicle",'Action'])
    ...
    def go_to_history_details(self,folder_path):
        ...
        self.history_details_table.setItem(row_count, 0, QTableWidgetItem("Total No Illegal Vehicle"))
        ...
        row_count = self.history_details_table.rowCount()
        self.history_details_table.insertRow(row_count) 
        self.history_details_table.setItem(row_count, 0, QTableWidgetItem("Total Illegal Vehicle"))
